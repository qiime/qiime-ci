...
sed -i -e"s?repository-location: git://github.com/qiime/qiime.git?repository-location: $WORKSPACE/qiime\nlocal-repository: yes?" qiime-deploy-conf/qiime-1.8.0-dev/qiime.conf
sed -i -e"s?log-level: INFO?log-level: DEBUG?" qiime-deploy-conf/qiime-1.8.0-dev/qiime.conf
cp -r /home/ubuntu/qiime_software .
rm -rf qiime_software/*-latest-r-package
python qiime-deploy/qiime-deploy.py qiime_software -f qiime-deploy-conf/qiime-1.8.0-dev/qiime.conf --force-remove-failed-dirs --force-remove-previous-repos
