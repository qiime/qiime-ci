...
sed -i -e"s?repository-location: https://pprospector.svn.sourceforge.net/svnroot/pprospector/trunk?repository-location: $WORKSPACE/primer-prospector\nlocal-repository: yes?" qiime-deploy-conf/primer-prospector-dev/primer-prospector.conf
cp -r /home/ubuntu/qiime_software primer_prospector_software
python qiime-deploy/qiime-deploy.py primer_prospector_software -f qiime-deploy-conf/primer-prospector-dev/primer-prospector.conf --force-remove-failed-dirs --force-remove-previous-repos
