...
sed -i -e"s?repository-location: https://github.com/pycogent/pycogent.git?repository-location: $WORKSPACE/pycogent\nlocal-repository: yes?" qiime-deploy-conf/pycogent-dev/pycogent.conf
cp -r /home/ubuntu/qiime_software pycogent_software
python qiime-deploy/qiime-deploy.py pycogent_software -f qiime-deploy-conf/pycogent-dev/pycogent.conf --force-remove-failed-dirs --force-remove-previous-repos
